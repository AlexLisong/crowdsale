...
contract MyTestingToken is ERC20Interface, Owned, Pausable, SafeMath {
    ...
    // Get the token balance for tokenOwner account 
	...
	function mint(address recipient, uint value) public onlyOwner whenNotPaused {
